...
cat(paste(star_out, collapse = "\n"), "\n", file='tables/compliance_cases_community_norms_mask.txt')
...
Oct 25"
  ...
  theme_linedraw()+
  ggtitle("Effect of Community Mask Attitudes on COVID-19 Cases")+
  theme(plot.title = element_text(hjust = 0.5))




ggsave('plots/compliance_cases_community_norms_mask.pdf',
       width = 7,
       height = 4,
       dpi = 300)
