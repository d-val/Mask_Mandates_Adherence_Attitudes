...
daily_w_mandates_df <- read_csv("data/output/daily_data_df_FM_ALL_produced_2021-02-17 21.52.csv") # data until Sep 27th
...
# ggsave('plots/daily_event_study_state_level_mandates_FM_ALL.pdf',
# width = 8,
# height = 10,
# dpi = 300)
