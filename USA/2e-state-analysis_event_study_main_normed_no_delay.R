...
daily_w_mandates_df <- read_csv("data/output/daily_data_with_other_NPI_df_produced_2021-02-12 15.14.csv")
...
# 
# ggsave('plots/daily_event_study_state_level_mandates_no_delay.pdf',
# width = 8,
# height = 10,
# dpi = 300)
