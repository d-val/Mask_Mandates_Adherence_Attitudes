...
daily_w_mandates_df <- read_csv("data/output/daily_data_df_FM_EMP_produced_2021-02-17 22.03.csv") # data until Sep 27th
...
# ggsave('plots/daily_event_study_state_level_mandates_FM_EMP.pdf',
# width = 8,
# height = 10,
# dpi = 300)
